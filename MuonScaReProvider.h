...
namespace correction {
    ...
    public:
        ...
        RVecLV getES(const RVecF& Muon_pt, const RVecF& Muon_eta, const RVecF& Muon_phi, const RVecF& Muon_mass, const RVecI& Muon_charge, const RVecUC& Muon_nTrackerLayers, const bool is_data, UncSource source, UncScale scale) const
        {
            ...
            for(size_t n = 0; n < Muon_pt.size(); ++n) {
                ...
                const UncScale mu_scale = sourceApplies(source)
    ...
    private:
        ...
        double pt_resol(double pt, double eta, float nL) const {
